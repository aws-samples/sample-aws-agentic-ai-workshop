...
> - Chapter [01-single-agent](../01-single-agent/README.md) recommended, since this chapter builds on the agent from [`../01-single-agent/completed/basic.py`](../../../dev/01-single-agent/completed/basic.py)
