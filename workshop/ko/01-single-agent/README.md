...
<p align="center"><a href="README.md">한국어</a> | <a href="../../en/01-single-agent/README.md">English</a></p>

## 목차

- [1. 기본 에이전트 만들기](#1-기본-에이전트-만들기)
- [2. Knowledge Base 연동](#2-knowledge-base-연동)
- [3. MCP 도구 연동](#3-mcp-도구-연동)
- [4. (응용) 자가개선 에이전트](#4-응용-자가개선-에이전트)
- [리소스 정리](#리소스-정리)
- [트러블슈팅](#트러블슈팅)
...
![Strands SDK 구성 요소](../../images/c1-strands-diagram.png)
...
![labs와 completed 폴더](../../images/c1-labs.png)

아래 모든 명령어는 [00-setup](../00-setup/README.md)에서 만든 uv 환경이 준비된 상태에서 **레포지토리 루트**에서 실행하는 것을 기준으로 합니다.
...
> [!NOTE]
> 이 챕터에 있었던 Streamlit 챗봇 UI는 다른 챕터로 이동했습니다. [03. 챗봇 애플리케이션](../03-chatbot-app/README.md)을 참고하세요.
...
![calculator 실행 결과](../../images/c1-calculator.png)
...
![BedrockModel 실행 결과](../../images/c1-bedrockmodel.png)
...
![Reasoning과 Response 분리 출력](../../images/c1-reasoning.png)
...
![커스텀 도구 실행 결과](../../images/c1-customtool1.png)
...
![python repl 도구 실행 결과](../../images/c1-customtool-py.png)

주석 처리된 다른 user_input도 시도해보세요. bash 명령어를 실행하는 tool을 호출하여, 아래와 같은 결과가 표시됩니다.

![bash 도구 실행 결과](../../images/c1-customtool-bash.png)
...
![S3](../../images/c1-2-s3_1.png)

**1-2.** **Create bucket** 버튼을 클릭하여 새로운 S3 버킷을 생성합니다.

![S3 Create Bucket](../../images/c1-2-s3_2.png)
...
![S3 Bucket Name](../../images/c1-2-s3_3.png)
...
![Bedrock Create KB](../../images/c1-2-kb_4.png)
...
![Bedrock Check KB](../../images/c1-2-kb_6.png)

**3-2.** **Test knowledge base** 섹션에서 **Select model** 버튼을 클릭합니다.

![Bedrock Test KB](../../images/c1-2-kb_7.png)

**3-3.** Claude 모델을 선택한 후 **Apply** 버튼을 클릭합니다.

![Bedrock Choose Model](../../images/c1-2-kb_8.png)

**3-4.** 질문을 입력하고 **Run** 버튼을 클릭하여 응답을 확인합니다.

![Bedrock KB Run](../../images/c1-2-kb_9.png)
...
![Bedrock Get KB ID](../../images/c1-2-kb_10.png)
...
![MCP 도구 실행 결과](../../images/c1-mcptool.png)
...
![에이전트가 도구 파일을 직접 작성](../../images/c1-4-self-extending-1.png)

![방금 만든 도구를 바로 호출](../../images/c1-4-self-extending-2.png)

**1-7.** 실습 디렉토리의 `tools/` 폴더를 열어보면, 에이전트가 방금 **직접 작성한 도구 파일**이 실제로 저장되어 있는 것을 확인할 수 있습니다. 이 파일은 다음 실행에서도 그대로 다시 로드됩니다.

![에이전트가 생성한 도구 파일](../../images/c1-4-generated-tool.png)
...
![에이전트가 자신의 시스템 프롬프트를 갱신](../../images/c1-4-self-modifying.png)
...
![영속화된 .prompt 파일](../../images/c1-4-persisted-prompt.png)
