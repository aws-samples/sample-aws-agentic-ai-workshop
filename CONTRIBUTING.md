...
* The chapter and file the problem is in
* The version of the Strands Agents SDK you are running (`uv pip show strands-agents`)
* The AWS region you are running in
